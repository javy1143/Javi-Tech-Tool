...
# --- Software Install Functions using Chocolatey ---
function Install-GoogleChrome {
    Log-Message "Installing Google Chrome..."
    try {
        choco install googlechrome -y | Out-Null
        Log-Message "Google Chrome installed."
    } catch {
...
function Install-RingCentral {
    ...
    try {
        choco install ringcentral -y | Out-Null
        Log-Message "RingCentral installed."
    } catch {
...
function Install-MicrosoftTeams {
    ...
    try {
        ...
        Log-Message "Microsoft Teams installed."
    } catch {
        ...
        try {
            ...
            foreach ($file in $files) {
                ...
                try {
                    ...
                    Log-Message "Skipping file: $($file.FullName)"
                }
            }
